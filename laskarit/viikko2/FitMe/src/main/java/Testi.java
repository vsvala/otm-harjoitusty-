...
//        ikkuna.setTitle("FixMe diary");//otsikko
//
//
...
//       
//        
//        Label label1 = new Label("Breakfast:");  
//        TextField textField = new TextField ();
//    
//        
//           
//       Button nappi = new Button("Submit");//käyttöliittymäkomponentti nappi
//             
//        FlowPane komponenttiryhma = new FlowPane();//asettelu
...
//        
//        
//        komponenttiryhma.getChildren().add(label1); 
//        komponenttiryhma.getChildren().add(textField);
//        komponenttiryhma.getChildren().add(nappi);
//        
//        Scene nakyma = new Scene(komponenttiryhma); //ikkunan näkymä
//
