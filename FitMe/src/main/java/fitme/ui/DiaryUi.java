...
//    public void createSummaryView(Stage primaryStage, Scene logincene, Scene diarySchene) throws SQLException {
//
//////        int totalKcal = diaryService.countKcal();
...
//        Scene summaryScene = new Scene(mainPanes, 700, 700); //säädetäänkoko
//
...
//
//            try {
//               String date = dateStartInput.getText();
////            to=dateToInput.getText();
//                fu.redrawViewSummarySearch();
//            } catch (SQLException ex) {
//                Logger.getLogger(FitMeUi.class.getName()).log(Level.SEVERE, null, ex);
//            }
//
